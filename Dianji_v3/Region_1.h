...
int Run_Output_1(IloEnv env, int &it, float lamda[], float Pipe[][25])
{
	env.out() << "--------------------------- Region 1 ------------------------ " << endl;
	//**********定义全局变量************
	IloInt cycle;			
	IloInt thUnitNum;  
	IloInt windUnitNum;
	...
	const char* lp = "./Bus31_1/hydrothermal.lp" ;    
	const char* SYSTEMDATA= "./Bus31_1/SystemData.dat" ;  //cycle J horizon flk tlk
	const char* APPDATA ="./Bus31_1/AppData.dat";     //I,K,LAMDA,PR DISK
	const char* THUNITDATA= "./Bus31_1/thunitdata.dat";
	const char* WINDDATA="./Bus31_1/windpower.dat";
	const char* NETDATA= "./Bus31_1/netdata.dat";
	const char* GAMADATA ="./Bus31_1/gamadata.dat";
	string _output = "./Bus31_1/Result_Output_"+int2str(it)+".dat";
	string _thunit = "./Bus31_1/Result_ThUnit_"+int2str(it)+".dat";
	string _result = "./Bus31_1/Result_"+int2str(it)+".dat";
	string _check = "./Bus31_1/Check_"+int2str(it)+".dat";
	...
	const char* Result_Line="./Bus31_1/Result_Line.dat";
